  ...
  return (
    ...
    >
      <div className="relative flex-grow">
        <span className="text-4xl text-muted/20 absolute -top-3 -left-2 font-serif leading-none select-none">
          “
        </span>
      ...
      <div className="flex flex-col gap-3">
        <p className="text-muted-foreground font-medium text-sm pl-2">
          — {author}
        </p>
        ...
        <div className="flex flex-wrap gap-2 pl-2">
          {tags.map((tag) => (
            <span
              key={tag}
              className="text-[10px] uppercase tracking-wider font-bold px-2 py-1 bg-secondary text-secondary-foreground border border-border"
            >
              {tag}
            </span>
          ))}
